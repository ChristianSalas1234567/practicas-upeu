...
def bonodeantiguedadparaempleados():
  ...
  #proceso
  if añostrabajados:
    if añostrabajados==1:print("bono de $100")
    if añostrabajados==2:print("bono de $200")
    if añostrabajados==3:print("bono de $300")
    if añostrabajados==4:print("bono de $400")
    if añostrabajados==5:print("bono de $500")
    if añostrabajados>5:print("bono de $1000")
